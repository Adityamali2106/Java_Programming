...
class Matrix
{
    ...
    //  Discription 	: It is used to count a frequency of a given element
    //  Input 			: Element to calculate frequency
    //  Output 			: Frequency of a element in matrix
    //  Author 			: Aditya Vijay Mali
    //  Date 			: 23/02/2026
    //
    ///////////////////////////////////////////////////////////////////////////////////////////////
...
class program72_2
{
    public static void main(String A[]) 
    {
        ...
        System.out.println("Enter Element to calculate frequency ");
        iValue = sobj.nextInt();
        System.out.println("Total frequency of "+iValue+" is "+ mobj.CountFrequency(iValue));
    }
}